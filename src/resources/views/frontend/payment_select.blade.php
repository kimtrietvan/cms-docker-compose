                            ...
                            <div class="card-body text-center px-4 pt-0">
                                <div class="row gutters-10">
                                    ...
                                    @if (addon_is_activated('paytm'))
                                        ...
                                        @endif
                                        @if (get_setting('payos_payment') == 1)
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('Payos') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        @endif
                                        @if (get_setting('vnpay_payment') == 1)
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('VNPay') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
                                        @endif
                                        @if (get_setting('zalopay_payment') == 1)
                                            <div class="col-6 col-xl-3 col-md-4">
                                                <label class="aiz-megabox d-block mb-3">
                                                    ...
                                                    <span class="d-block aiz-megabox-elem p-3">
                                                        ...
                                                        <span class="d-block text-center">
                                                            <span
                                                                class="d-block fw-600 fs-15">{{ translate('ZaloPay') }}</span>
                                                        </span>
                                                    </span>
                                                </label>
                                            </div>
