<?php if($detailedProduct->added_by == 'seller' && $detailedProduct->user->shop != null): ?>
    <div class="border mb-4" style="background: #fcfcfd;">
        <div class="position-relative p-3 p-sm-4 text-left">
            ...
            <div class="mt-3">
                <a href="<?php echo e(route('shop.visit', $detailedProduct->user->shop->slug)); ?>"
                    class="btn btn-block btn-slide-secondary-base fs-14 fw-700 rounded-0"><?php echo e(translate('Visit Store')); ?></a>
            </div>
        </div>
    </div>
<?php endif; ?><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/frontend/product_details/seller_info.blade.php ENDPATH**/ ?>