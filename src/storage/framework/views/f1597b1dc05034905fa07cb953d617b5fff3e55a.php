<div class="modal fade" id="fq-brought-product-select-modal">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" style="min-height: 300px;">
                <div class="row gutters-5">
                    <div class="col-md-6">
                        <select class="form-control aiz-selectpicker" name="fq_brough_category" onchange="filterFqBroughtProduct()" data-placeholder="<?php echo e(translate('Select a Category')); ?>" data-live-search="true">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control" name="search_keyword" onkeyup="filterFqBroughtProduct()" placeholder="<?php echo e(translate('Search by Product Name')); ?>">
                    </div>
                </div>
            ...
            <div class="modal-footer">
                <button 
                    ...
                    onclick="addFqBroughtProduct()"
                ><?php echo e(translate('Add')); ?></button>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/modals/product_select_modal.blade.php ENDPATH**/ ?>