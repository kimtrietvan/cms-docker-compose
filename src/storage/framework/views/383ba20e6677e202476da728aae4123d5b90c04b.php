...
<div class="aiz-demo-nav">
    ...
    <div class="bg-white position-relative">
        <a href="javascript:void(0);" class="position-relative aiz-demo-nav-item aiz-demo-nav-toggler">
            ...
            <span><?php echo e(translate('Demos')); ?></span>
        </a>
    </div>
    <!-- Mobile bottom nav toggler-->
    <div class="aiz-demo-nav-links">
        <a href="https://activeitzone.com/docs/active-ecommerce-cms/" class="aiz-demo-nav-item" target="_blank">
            ...
            <span class="mt-1"><?php echo e(translate('Docs')); ?></span>
        </a>
        <a href="https://www.youtube.com/watch?v=FFjausSYe3M" class="aiz-demo-nav-item" target="_blank">
            ...
            <span class="mt-1"><?php echo e(translate('Tutorial')); ?></span>
        </a>
        <a href="https://www.youtube.com/watch?v=zW6FwRsaxDk" class="aiz-demo-nav-item" target="_blank">
            ...
            <span class="mt-1"><?php echo e(translate('Promo')); ?></span>
        </a>
    </div>
</div>
                ...
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_main.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Active eCommerce Main Demo')); ?></p>
                </div>
                <!-- Grocery Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-grocery/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_grocery.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Grocery Store')); ?></p>
                </div>
                <!-- Electronics Shop -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-electronics/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_technology.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Electronics Shop')); ?></p>
                </div>
                <!-- Fashion Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-fashion/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_fashion.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Fashion Store')); ?></p>
                </div>
                <!-- Automobile Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-automobile/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_automobile.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Automobile Store')); ?></p>
                </div>
                <!-- Furniture Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-furniture/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_furniture.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Furniture Store')); ?></p>
                </div>
                <!-- Medical Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-medical/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_medical.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Medical Store')); ?></p>
                </div>
                <!-- Sports Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-sports/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_sports.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Sports Store')); ?></p>
                </div>
                <!-- Construction Store -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                        <a href="https://demo.activeitzone.com/ecommerce-construction/" target="_blank" class="h-100 w-100">
                            <img src="<?php echo e(static_asset('assets/img/demo/demo_thumb_construction.png')); ?>">
                        </a>
                    </div>
                    <p class="demo-title"><?php echo e(translate('Construction Store')); ?></p>
                </div>
                <!-- Demo content -->
                <div class="col-md-6 my-3">
                    <div class="demo-img-content">
                    ...
                    <p class="demo-title"><?php echo e(translate('Coming Soon')); ?></p>
                </div>
            </div>
        </div>
    </div>
</div><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/frontend/inc/demo_nav.blade.php ENDPATH**/ ?>