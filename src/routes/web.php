...
//Stripe END
//Payos Start
Route::controller(PayosController::class)->group(function () {
    Route::get('/payos/return', 'result')->name("payos.return");
    Route::get('/payos/cancel', 'cancel')->name('payos.cancel');
});
//Payos END
//VNPAY start
Route::controller(VnpayController::class)->group(function () {
    Route::get('/vnpay/return', 'result')->name('vnpay.return');
    Route::get('/vnpay/ipn', 'ipn')->name('vnpay.ipn');
});
//VNPAY END

Route::controller(ZalopayController::class)->group(function () {
    Route::post('/zalopay/callback', 'callback')->name('zalo.callback');
});
