...
<div class="aiz-carousel dashboard-box-carousel half-outside-arrow" data-items="6.5" data-xl-items="5" data-lg-items="4.5"
    ...
    ?>
    <?php $__currentLoopData = $top_categories_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $top_categories_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="carousel-box topproducts top_category_products <?php if($key == $top_categories2[0]): ?> active <?php endif; ?>" onclick="top_category_products(<?php echo e($key); ?>, this)">
            <div class="size-80px border border-dashed rounded-2 overflow-hidden p-1">
                <div class="h-100 rounded-2 overflow-hidden d-flex align-items-center">
                    <img src="<?php echo e(uploaded_asset($top_categories_product[0]->cover_image)); ?>" alt="<?php echo e(translate('category')); ?>" 
...
<div class="position-relative">
    ...
    ?>
    <?php $__currentLoopData = $top_categories_products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $top_categories_product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <div class="top_category_product_table top-products-table table-responsive c-scrollbar-light <?php if($key == $top_categories2[0]): ?> show <?php endif; ?>" style="max-height: 215px; width: 100%;" id="top_category_product_table_<?php echo e($key); ?>">
            <table class="table dashboard-table mb-0">
                ...
                <tbody>
                    <?php $__currentLoopData = $top_categories_product; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                            $product_img = null;
        ...
        ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
</div><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/backend/dashboard/top_category_products_section.blade.php ENDPATH**/ ?>