                ...
                <div class="demo-admin-links w-100 py-5 my-lg-5 px-4 mx-auto">
                    <div class="row overflow-hidden rounded-3" style="border: 1px solid #f2f2f2;">
                        <div class="col-md-6 px-0 d-none d-md-block"  style="border-right: 1px solid #f2f2f2;">
                            <img class="img-fit h-100" src="<?php echo e(my_asset('assets/img/demo/link/link.png')); ?>" alt="Active eCommerce CMS">
                        </div>
                        <div class="col-md-6 px-2rem py-5 d-flex flex-column justify-content-center">
                            <div class="mb-4 text-center">
                                <img class="h-40px" src="<?php echo e(my_asset('assets/img/demo/link/logo.svg')); ?>" alt="Active eCommerce CMS">
                            </div>
...
</html><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/frontend/handle_demo_login.blade.php ENDPATH**/ ?>