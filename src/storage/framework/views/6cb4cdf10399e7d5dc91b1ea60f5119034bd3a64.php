                    ...
                    <div class="card-body">
                        <div class="d-flex border-bottom pb-3">
                            <div class="flex-grow-1">
                                ...
                                ?>
                                <select name="user_id" class="form-control aiz-selectpicker pos-customer" data-live-search="true" onchange="getShippingAddressUpdateCartData()" data-selected="<?php echo e($userID); ?>">
                        ...
                        <div class="" id="cart-details">
                            <div class="aiz-pos-cart-list mb-4 mt-3 c-scrollbar-light">
                                ...
                                <?php if(count($carts) > 0): ?>
                                    ...
                                    <?php $__empty_1 = true; $__currentLoopData = $carts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $cartItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <?php
                                            ...
                                            <div class="row gutters-5 align-items-center">
                                                <div class="col-auto w-60px">
                                                    <div class="row no-gutters align-items-center flex-column aiz-plus-minus">
                                                        <button class="btn col-auto btn-icon btn-sm fs-15" type="button" data-type="plus" data-field="qty-<?php echo e($cartID); ?>" <?php if($product->digital == 1): ?> disabled <?php endif; ?>>
                                                            <i class="las la-plus"></i>
                                                        </button>
                                                        <input type="text" name="qty-<?php echo e($cartID); ?>" id="qty-<?php echo e($cartID); ?>" class="col border-0 text-center flex-grow-1 fs-16 input-number" placeholder="1" value="<?php echo e($cartItem['quantity']); ?>" min="<?php echo e($product->min_qty); ?>" max="<?php echo e($stock->qty); ?>" onchange="updateQuantity(<?php echo e($cartID); ?>)">
                                                        <button class="btn col-auto btn-icon btn-sm fs-15" type="button" data-type="minus" data-field="qty-<?php echo e($cartID); ?>" <?php if($product->digital == 1): ?> disabled <?php endif; ?>>
                                                            <i class="las la-minus"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="col">
                                                    <div class="text-truncate-2"><?php echo e($product->name); ?></div>
                                                ...
                                                <div class="col-auto">
                                                    <button type="button" class="btn btn-circle btn-icon btn-sm btn-soft-danger ml-2 mr-0" onclick="removeFromCart(<?php echo e($cartItem->id); ?>)">
...
<?php $__env->startSection('modal'); ?>
    ...
    <div id="change-customer" class="modal fade" role="dialog">
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom" role="document">
            <div class="modal-content">
                <div class="modal-header bord-btm">
                    <h4 class="modal-title h6"><?php echo e(translate('Change Customer Confirmation')); ?></h4>
                    <button type="button" class="close" data-dismiss="modal"><span aria-hidden="true">&times;</span></button>
                </div>
                <form id="shipping_form">
                    <div class="modal-body">
                        <p class="mt-1 fs-14"><?php echo e(translate('If you have cart data and change customers, cart data for the previous customer will be removed.')); ?></p>
                    </div>
                </form>
                <div class="modal-footer">
                    <button type="button" class="btn btn-styled btn-base-3" data-dismiss="modal" id="close-button"><?php echo e(translate('Close')); ?></button>
                    <button type="button" class="btn btn-primary btn-styled btn-base-1" onclick="updateSessionUserCartData()" data-dismiss="modal"><?php echo e(translate('Confirm')); ?></button>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class=" row">
                            ...
                            <div class="col-sm-9">
                                <input placeholder="<?php echo e(translate('Amount')); ?>" id="offline_payment_amount" name="offline_payment_amount" class="form-control" readonly required>
                            </div>
                        </div>
                    </div>
...
<?php $__env->startSection('script'); ?>
    <script type="text/javascript">
        ...
        function removeFromCart(id){
            $.post('<?php echo e(route('pos.removeFromCart')); ?>', {_token:AIZ.data.csrf, id:id}, function(data){
                updateCart(data);
            });
        }
        ...
        function updateQuantity(cartId){
            $.post('<?php echo e(route('pos.updateQuantity')); ?>',{_token:AIZ.data.csrf, cartId:cartId, quantity: $('#qty-'+cartId).val()}, function(data){
                if(data.success == 1){
                    updateCart(data.view);
                }else{
                    AIZ.plugins.notify('danger', data.message);
        ...
        function updateSessionUserCartData(){
            $.post('<?php echo e(route('pos.updateSessionUserCartData')); ?>',{_token:AIZ.data.csrf, userId:$('select[name=user_id]').val()}, function(data){
                updateCart(data);
            });
        }
...
<?php echo $__env->make('backend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/backend/pos/index.blade.php ENDPATH**/ ?>