    ...
    <?php if($topbar_banner != null): ?>
        <div class="position-relative top-banner removable-session z-1035 d-none" data-key="top-banner"
            ...
            <a href="<?php echo e(get_setting('topbar_banner_link')); ?>" class="d-block text-reset h-40px h-lg-60px">
                <!-- For Large device -->
                <img src="<?php echo e($topbar_banner_asset); ?>" class="d-none d-xl-block img-fit h-100" alt="<?php echo e(translate('topbar_banner')); ?>">
                <!-- For Medium device -->
                ...
                <div class="d-flex align-items-center">
                    ...
                    <div class="d-none d-lg-block ml-3 mr-0">
                        <div class="" id="compare">
                            <?php echo $__env->make('frontend.'.get_setting('homepage_select').'.partials.compare', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                    <!-- Wishlist -->
                    <div class="d-none d-lg-block mr-3" style="margin-left: 36px;">
                        <div class="" id="wishlist">
                            <?php echo $__env->make('frontend.'.get_setting('homepage_select').'.partials.wishlist', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                    <?php if(!isAdmin()): ?>
                        <!-- Notifications -->
                ...
                <div class="d-flex h-100">
                                    ...
                                    <?php $__currentLoopData = json_decode(get_setting('header_menu_labels'), true); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <li class="list-inline-item mr-0 animate-underline-white">
                                            <a href="<?php echo e(json_decode(get_setting('header_menu_links'), true)[$key]); ?>"
                                                class="fs-13 px-3 py-3 d-inline-block fw-700 <?php echo e($nav_txt_color); ?> header_menu_links hov-bg-black-10
                    ...
                    <div class="d-none d-xl-block align-self-stretch ml-5 mr-0 has-transition bg-black-10"
                        ...
                        <div class="nav-cart-box dropdown h-100" id="cart_items" style="width: max-content;">
                            <?php echo $__env->make('frontend.'.get_setting('homepage_select').'.partials.cart', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH /Users/truongdinh/code/php/Demo/resources/views/frontend/inc/nav.blade.php ENDPATH**/ ?>